                ...
                <div class="formulario">
               	  <div class="media">
                        ...
                        <div style=" background-color:#e7eff4; width:498px; border:2px solid #a4bac6; padding:10px; margin:23px auto; ">
	                        <h3 style=" background-color:#13344e; border: 1px solid #a4bac6; font-weight:bold; color: #ffffff; font-size: 13px; line-height: 37px; margin: 0; min-height: 37px; padding: 0 11px; text-transform: uppercase;  white-space: nowrap;"> SERVIÇOS PARA O CIDADÃO </h3>
