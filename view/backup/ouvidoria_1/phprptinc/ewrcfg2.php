...
define("EW_REPORT_CONN_HOST", "10.10.100.41", TRUE);
define("EW_REPORT_CONN_PORT", 3306, TRUE);
define("EW_REPORT_CONN_USER", "anderson", TRUE);
define("EW_REPORT_CONN_PASS", "123", TRUE);
define("EW_REPORT_CONN_DB", "sect", TRUE);
...
define("EW_REPORT_RANDOM_KEY", 'HJYTYU4YEYHM73CP', TRUE); // Random key for encryption
define("EW_REPORT_CHART_SCRIPT", 'ouvidoria_1/ewchartfcf.php', TRUE);
...
define("EW_REPORT_USERLEVEL_ARRAY_FIELD", "", TRUE);
