...
<?php while ($l = mysql_fetch_array($res_e)) { ?>
...
if ($linha['status_atual']=='Respondida')
$cor='#456de0';
...
echo "<tr style='color:$cor;font-weight:bold'><td>".$linha['protocolo']."</td>
    ...
    <td><a href='index.php?pg=21&p=".$linha['id_ouvidoria']."'><img src='../../imagens/lupa.png' border='0'><a></td>
 </tr>";
...
echo "<a href='index.php?pg=20&ini=$in'>".$j."</a>&nbsp;";
$in+=10;
}
?>
</td>
