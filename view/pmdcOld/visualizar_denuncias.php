...
<form name='form' method='post'>
	...
	<table width="100%" border="0" id="tabela" class="tablesorter">
		...
		<tr style='color:<?php echo $cor; ?>;font-weight:bold'>
			...
			<td>
				<a href="?pg=20&id=<?php echo $r['id_ouvidoria']; ?>"><img src='../../imagens/pmdc/lupa.png' border='0'><a>
			</td>
		</tr>
		<?php } ?>
		</tbody>		
			...
			<td colspan=8>
				<?php for ($i=0;$i<$num;$i++) { ?>
					<?php if ($i == ($_GET['inicio']/10)) {
						...
						<a href="../faetec/?pg=19&amp;inicio=<?php echo $i*10; echo $filtro; ?>"><?php echo $i+1; ?></a>
					<?php } ?>
				<?php }?>
			</td>
		</tr>		
