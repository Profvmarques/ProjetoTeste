...
$("#form").validate({
		...
		messages: {
			diretoria: " Selecione uma nova diretoria",
			entidadeselect: " Selecione a entidade",
		}
	});
});
</script>
...
<form name="form" id='form' method="POST">
	<table width="100%" border="0" align="center" cellpadding="2" cellspacing="2">
		<tr>
			<td width="15%"><span>Nova Diretoria:</span><span class="asterisco">*</span></td>
			<td>
