...
$().ready(function() {
	...
	$("#form").validate({
		...
		messages: {
			...
			coments: "Preencha o campo Den&uacute;ncia",
...
<br>
<div style="color:#FF0000; font-weight:bold;">INFORMA&Ccedil;&Otilde;ES DO DENUNCIANTE</div>
<br>
<form name="form" id="form" method="POST" enctype='multipart/form-data'>
    ...
    <br />
	<br>
	<div style="color:#FF0000; font-weight:bold;">DEN&Uacute;NCIA*</div>
	<span style="font-weight:bold; color:#666666">&Eacute; a primeira vez que voc&ecirc; faz esta den&uacute;ncia?</label>
	...
	<textarea name="comentario" cols="80" rows="6"  id="resumo" title="Preencha o campo ComentÃ¡rio"></textarea>
