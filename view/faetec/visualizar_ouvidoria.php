...
<form name='form' method='post'>
	<fieldset >
        ...
        <div class="form-group campof">
            <label>Modalidade de Ensino</b></label>
        ...
        <div class="form-group campo">
			<input type='button' class="btn btn-success" value='Filtrar' onclick="document.getElementById('filtrar').value=1;document.form.submit();">
		</div>
	</fieldset>
