...
<link href="../../css/faetec/style_protocolo.css" rel="stylesheet" type="text/css"/>
</head>

<body>
	<div style="border:solid; border-color:#333300; width:875px;">
		<table border="0" width="100%" cellpadding="10" cellspacing="5">
			<tr>
				<td>
					<img src="../../imagens/faetec/logo_gov.jpg" border="0" />
				</td>
			</tr>
			<tr>
				<td>
				...
				Caso seja um e-mail inv&aacute;lido, a mesma poder&aacute; ser acompanhada em nosso site (http://www.duquedecaxias.rj.gov.br/portal/ouvidoria/) com o n&uacute;mero do protocolo abaixo:
				</td>
			</tr>
			<tr>
				<td>
