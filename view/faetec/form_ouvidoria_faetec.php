...
<form name="form" id="form" method="POST" enctype='multipart/form-data'>
	<label style="font-weight:bold; color:#666666">O que você deseja registrar na ouvidoria?</label>
	<select name="tipo" id="tipo" title="Selecione o Tipo de registro">
	...
	<br>
	<label style="font-weight:bold; color:#666666" for="sub">Por favor, informe o assunto da mensagem que você quer enviar. </label>
	...
	<br>
	<label style="font-weight:bold; color:#666666" for="tipo_usuario">Classifica&ccedil;&atilde;o do cidad&atilde;o:*</label>
