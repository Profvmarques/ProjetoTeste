...
controle_processos('incluir_denuncia');
...
<link rel="stylesheet" type="text/css" href="../../css/faetec/style_denuncia.css" />
...
$().ready(function() {
	...
	$("#form").validate({
		...
		messages: {
			...
			comentario: "Preencha o campo Den&uacute;ncia"
		}
	});
...
<body style="width:1024px; margin-left:25px;">
    <img src="../../imagens/faetec/nova_logo_ouvidoria.jpg">
    <br />
<br />
 
   <div style="color:#0000CC;font-weight:bold;font-size:24px;">Termo de Den&uacute;ncia</div>
<br>

<div style="color:#FF0000; font-weight:bold;">INFORMA&Ccedil;&Otilde;ES AO DENUNCIANTE</div>
<br><div align="justify" style="font-weight:bold">
- A identifica&ccedil;&atilde;o do Denunciante n&atilde;o &eacute; obrigat&oacute;ria, por&eacute;m &eacute; desej&aacute;vel, na medida em que possibilita a eventual solu&ccedil;&atilde;o de d&uacute;vidas quanto aos fatos apontados.<br>
- Todas as informa&ccedil;&otilde;es ser&atilde;o mantidas sob sigilo, quando solicitado pelo denunciante.<br>
- A Den&uacute;ncia que n&atilde;o contiver fundamenta&ccedil;&atilde;o m&iacute;nima  n&atilde;o ser&aacute; considerada pela Ouvidoria Geral da FAETEC.<br>
</div>
<br>
<form name="form" id="form" method="POST" enctype='multipart/form-data'>
	...
	<label style="font-weight:bold; color:#666666">E-mail:<span>*</span></label>
	...
	<br>
	<label style="font-weight:bold; color:#666666" for="entidade">Entidade a que se refere o assunto:<span>*</span></label>
	...
	<br>
	<br>
	<div style="color:#FF0000; font-weight:bold;">DEN&Uacute;NCIA<span>*</span></div>
	
	<br>
	<div align="justify" style="font-weight:bold">Relatar o assunto de forma suscinta, por&eacute;m o  mais completo poss&iacute;vel, com informa&ccedil;&otilde;es e dados que possam servir como  subs&iacute;dios para viabilizar o encaminhamento da den&uacute;ncia.</div>
	<br>
	
  	<span style="font-weight:bold; color:#666666" class="texto">&Eacute; a primeira vez que voc&ecirc; faz esta den&uacute;ncia?</label>
	...
	<textarea name="comentario" cols="90" rows="6"  id="resumo" title="Preencha o campo ComentÃ¡rio" onkeyup='remover()'></textarea>
