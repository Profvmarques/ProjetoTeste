	...
	switch ($acao) {
		case 'incluir':
			...
			//criar objeto da classe tipos
                        $path = getcwd();
			require_once('/home/pmdc/public_html/portal/ouvidoria/classe/faetec/tipos.php');
			$tipos = new tipos();
			
			//criar objeto da classe entidades
			require_once('/home/pmdc/public_html/portal/ouvidoria/classe/entidades.php');
			$entidades = new entidades();
			
			//criar objeto da classe modalidades
			require_once('/home/pmdc/public_html/portal/ouvidoria/classe/faetec/modalidades.php');
			$modalidades = new modalidades();
			
			//criar objeto da classe deficiencia
			require_once('/home/pmdc/public_html/portal/ouvidoria/classe/deficiencia.php');
			$deficiencia = new deficiencia();
			
			//criar objeto da classe tipo_usuario
			require('/home/pmdc/public_html/portal/ouvidoria/classe/tipo_usuario.php');
			$tipo_usuario = new tipo_usuario();
			
			//criar objeto da classe assunto
			require('/home/pmdc/public_html/portal/ouvidoria/classe/faetec/assunto.php');
			$assunto = new assunto();
			...
			if ($_POST['incluir'] == 1) {
				...
				require_once('/home/pmdc/public_html/portal/ouvidoria/classe/faetec/processos.php');
				$processos = new processos();
				
				//chama a função de inclusão da classe processos
				$resultado = $processos -> incluir($_POST);
				if ($resultado != '') {
					echo "<script>window.location='http://www.duquedecaxias.rj.gov.br/portal/ouvidoria/view/faetec/protocolo.php?pr=".base64_encode($resultado)."'</script>"; 
					die;
				}
			}
		break;
		...
		case 'visualizar':
			...
			require_once('/home/pmdc/public_html/portal/ouvidoria/classe/status.php');
			$status = new status();
			...
			//criar objeto da classe assunto
			require_once('/home/pmdc/public_html/portal/ouvidoria/classe/faetec/assunto.php');
			$assunto = new assunto();
			
			//criar objeto da classe historico
			require_once('/home/pmdc/public_html/portal/ouvidoria/classe/faetec/historico.php');
		...
		case 'bloco':
			...
			require_once('/home/pmdc/public_html/portal/ouvidoria/classe/resposta_padrao.php');
		...
		case 'detalhes':
			...
			require_once('/home/pmdc/public_html/portal/ouvidoria/classe/prioridade.php');
			$prioridade = new prioridade();

			//criar objeto da classe tipo_usuario
			require_once('/home/pmdc/public_html/portal/ouvidoria/classe/tipo_usuario.php');
			$tipo_usuario = new tipo_usuario();
			...
			require_once('/home/pmdc/public_html/portal/ouvidoria/classe/usuario.php');
			$usuario = new usuario();
			...
			if ($_POST['btn_cidadao'] || $_POST['btn_vinculada']) {
				require_once('/home/pmdc/public_html/portal/ouvidoria/controle/mail/class.phpmailer.php');
					...
					/*foreach ($_FILES["file"]['tmp_name'] as $chave => $arq) {
						if ($arq != '') {
							...
							if ($tam < 1) {
								...
								if (!copy($arq, "/home/pmdc/public_html/portal/ouvidoria/anexos/".$anexo)) {
