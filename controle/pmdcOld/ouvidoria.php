...
function controle_ouvidoria($acao) {
	switch ($acao) {
		case 'incluir':
			...
			require_once('../../classe/faetec/entidades.php');
			...
			if ($_POST['incluir'] == 1) {
				...
				if ($resultado != '') {
					...
					echo "<img src='view/faetec/printButton.png'";
		...
		case 'detalhes':
			...
			if ($_POST['alterar'] == 1) {
				...
				if ($resultado == 1) {
					...
					echo "<script>window.location='index.php?pg=view/faetec/detalhes_ouvidoria.php&id=".$_POST['id_ouvidoria']."';</script>";
				}
			}
		break;
	}
